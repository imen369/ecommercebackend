...
var transporter =nodemailer.createTransport({
    service:'gmail',
    auth:{
    user:'daoud.imen1906@gmail.com',
    pass:'nrskdvpjfqyigxaw'
    },
    tls:{
...
router.post('/forgot-password', (req, res) => {
    ...
    text: `http://${req.headers.host}/api/user/reset_password/${user._id}/${token}`
    };
...
var mailOption ={
    from: '"verify your email " <daoud.imen1906@gmail.com@gmail.com>',
    to: newUser.email,
    subject: 'Activation de compte ',
    html:`<h2>${newUser.firstname}! thank you for registreting on our website</h2>
    <h4>please verify your email to procced.. </h4>
    <a
    href="http://${req.headers.host}/api/user/status/edit?email=${newUser.email}">click here</a>`
    }
